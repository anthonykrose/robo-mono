...
data_periodD_file = ROOT.TFile("DataPeriodD.root")
...
# data_periodB_file: "PeriodB",
#           data_periodD_file: "PeriodD",
#           data_periodE_file: "PeriodE",
          

filenames3 = {data_periodF_file: "PeriodF",
...
for cut in cutlist.cuts_ditau_CR:
   print cut
   print cutlist.cutnames[cut]
   contents+=cutlist.cutnames[cut]
   for file1 in files1:
...
for file2 in files2:
   print filenames2[file2]
   contents += " & " + filenames2[file2]
contents += "\\\\\hline\n"
...
for cut in cutlist.cuts_ditau:
   ...
   contents+=cutlist.cutnames[cut]
   for file2 in files2:
      contents += " " +  "&" + " " + evnum(cut,file2)
   contents += "\\\\\\hline\n"

contents += "\\end{tabular}\\end{center}\n"
#THIS PART WILL SEPERATE DATA RUNS INTO PERIOD
...
for file3 in files3:
   print filenames3[file3]
   contents += " & " + filenames3[file3]
contents += "\\\\\hline\n"

for cut in cutlist.cuts_ditau_data:
   print cut
   print cutlist.cutnames[cut]
   contents+=cutlist.cutnames[cut]
   for file3 in files3:
      contents += " " +  "&" + " " + evnum(cut,file3)
   contents += "\\\\\\hline\n"
